...
public class Using_Nonerctangle_Array {
	public static void main(String[] args) {
			//비정방향 배열 : 각 행에 대해서 열의 갯수가 다를때
		
		//1. 방법1 비정방향 배열선언 후 방 크기를 생성 후 값 할당.
		int[][] arr1 = new int[2][];	//행의 방의 갯수만 지정, 열의 갯수는 나중에 지장함
		...
		//4. 방법4 비정방향 배열 선언시 값을 할당. (선언과 초기화 분리 불가능)
		int[][]arr5 = {{1,2},{3,4,5}};
