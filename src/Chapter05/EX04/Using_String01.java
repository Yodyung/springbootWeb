...
public class Using_String01 {
	...
	public static void main(String[] args) {
		// String : 참조 데이터 타입, 문자열을 처리, 아주 기능들이 많이 들어가 있음.
		
		//1. 객체 생성을 사용해서 값을 할당 (객체의 주소는 별개로 작동)
		String str1=new String("안녕");
					//new heap 메모리에 값을 할당
					//뒤의 String() : 생성자의 매개 변수에 "안녕" 문자열을 할당.
		...
		String str22="안녕하세요";		//str2와 str22는 동일한 번지를 가리킨다.
		System.out.println(str2==str22);	//객체의 값을 비교.
