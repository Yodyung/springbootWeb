...
public class Using_Array06 {
	...
	public static void main(String[] args) {
		...
		boolean[] array5= new boolean[3];		//기본값으로 false가 들어감
		System.out.println(array5[0]);
		
		int[] array6= new int[3];			//기본값으로 0들어감
		System.out.println(array6[0]);
		
		double[] array7 =new double[3];		// 기본값으로 0.0들어감
		System.out.println(array7[0]);
		
		String[] array8=new String[3];		//기본값으로 null들어감
