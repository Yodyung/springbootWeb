...
public class TypeCasting_3 {
	...
	public static void main(String[] args) {
		// 1. 같은 자료형 간의 연산
		int value1 = 3+5;
		int value2 = 8/5;		//주의 : 나눗셈을 할 경우 int 타입으로 정의되면 
								//정확한 값이 출력되지 않을 수 있음.
		double value2_1 = 8/5;	//부정확한 값 출력 (1.0)
		double value2_2 = 8.0/5;//정확한 값 출력 (1.6)
		
		float value3 = 3.0F + 5.0F;
		double value4 = 8.0 / 5.0;
		
		//byte, short 연산을 하게되면 정수(int)로 처리해야함.
		byte data1 = 3;
		byte data2 = 5;
		...
		//byte value5 = data1 + data2; 	//byte로 적용시 오류 발생함
		int value5 = data1 + data2;		//byte, short연산 후 int 타입으로 처리되어야함
	
		
		//short value5_2 = data3 + data4;	//short 적용시 오류 발생함
		...
		int value6 =(int)(5+3.5);	//int 다운캐스팅
